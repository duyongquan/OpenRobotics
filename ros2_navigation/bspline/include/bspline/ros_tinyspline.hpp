#ifndef BSPLINE__ROS_TINYSPLINE_HPP_
#define BSPLINE__ROS_TINYSPLINE_HPP_

// https://github.com/msteinbeck/tinyspline#documentation


#include <bspline/tinyspline.h>
#include <vector>
#include <string>
...
public:
	...
	explicit BSpline(size_t nCtrlp, size_t dim = 2, size_t deg = 3, bspline::BSpline::type type = TS_CLAMPED);
	~BSpline();
...
#endif  // BSPLINE__ROS_TINYSPLINE_HPP_