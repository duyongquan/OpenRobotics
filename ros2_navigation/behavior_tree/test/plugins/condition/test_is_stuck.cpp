...
#include "behavior_tree/plugins/condition/is_stuck_condition.hpp"

using namespace std::chrono;  // NOLINT
using namespace std::chrono_literals;  // NOLINT

class IsStuckTestFixture : public behavior_tree::BehaviorTreeTestFixture
{
public:
  void SetUp()
  {
    bt_node_ = std::make_shared<ros2_tutorials::behavior_tree::IsStuckCondition>("is_stuck", *config_);
  }
...
protected:
  static std::shared_ptr<ros2_tutorials::behavior_tree::IsStuckCondition> bt_node_;
};

std::shared_ptr<ros2_tutorials::behavior_tree::IsStuckCondition>
