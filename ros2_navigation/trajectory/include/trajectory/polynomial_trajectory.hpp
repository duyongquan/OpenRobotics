#ifndef TRAJECTORY_TOOLS__POLYNOMIAL_TRAJECTORY_HPP_
#define TRAJECTORY_TOOLS__POLYNOMIAL_TRAJECTORY_HPP_
...
private:
  ...
  std::vector<std::vector<double>> cxs;  // coefficient of x of each segment, from n-1 -> 0
...
#endif  // TRAJECTORY_TOOLS__POLYNOMIAL_TRAJECTORY_HPP_
