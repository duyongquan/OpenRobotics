...
// void PolyhedronArrayDisplay::processMessage(const decomp_ros_msgs::msg::PolyhedronArray::SharedPtr msg) {
...
//   const auto polys = decomp_ros::ros_to_polyhedron_array(*msg);
