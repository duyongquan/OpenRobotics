...
RVizInterface::RVizInterface(rclcpp::Node* node)
{
    node_ = node;
    // Initialize the transform broadcaster
    estimate_base_tf_br_ = std::make_shared<tf2_ros::TransformBroadcaster>(*node_);
    ground_truth_base_tf_br_ = std::make_shared<tf2_ros::TransformBroadcaster>(*node_);
    trajectory_base_tf_br_ = std::make_shared<tf2_ros::TransformBroadcaster>(*node_);

    // Load rosparams from parameter server
    std::string global_plan_topic;
    std::string local_plan_topic;
    std::string discrete_global_plan_topic;
    std::string foot_plan_discrete_topic;
    std::string foot_plan_continuous_topic;
    std::string state_estimate_topic;
    std::string ground_truth_state_topic;
    std::string trajectory_state_topic;
    std::string grf_topic;

    // Load topic names from parameter server
    quad_utils::loadROSParam(node_, "global_plan", global_plan_topic);
    quad_utils::loadROSParam(node_, "local_plan", local_plan_topic);
    quad_utils::loadROSParam(node_, "control/grfs", grf_topic);
    quad_utils::loadROSParam(node_, "global_plan_discrete", discrete_global_plan_topic);
    quad_utils::loadROSParam(node_, "foot_plan_discrete", foot_plan_discrete_topic);
    quad_utils::loadROSParam(node_, "foot_plan_continuous", foot_plan_continuous_topic);
    quad_utils::loadROSParam(node_, "state/estimate", state_estimate_topic);
    quad_utils::loadROSParam(node_, "state/ground_truth", ground_truth_state_topic);
    quad_utils::loadROSParam(node_, "state/trajectory", trajectory_state_topic);
    quad_utils::loadROSParamDefault(node_, "tf_prefix", tf_prefix_, std::string(""));

    std::string global_plan_viz_topic;
    std::string local_plan_viz_topic;
    std::string local_plan_ori_viz_topic;
    std::string global_plan_grf_viz_topic;
    std::string local_plan_grf_viz_topic;
    std::string current_grf_viz_topic;
    std::string discrete_body_plan_viz_topic;
    std::string foot_plan_discrete_viz_topic;
    std::string estimate_joint_states_viz_topic;
    std::string ground_truth_joint_states_viz_topic;
    std::string trajectory_joint_states_viz_topic;
    std::string state_estimate_trace_viz_topic;
    std::string ground_truth_trace_viz_topic;
    std::string trajectory_state_trace_viz_topic;

    quad_utils::loadROSParam(node_, "visualization/global_plan", global_plan_viz_topic);
    quad_utils::loadROSParam(node_, "visualization/local_plan", local_plan_viz_topic);
    quad_utils::loadROSParam(node_, "visualization/local_plan_ori", local_plan_ori_viz_topic);
    quad_utils::loadROSParam(node_, "visualization/global_plan_grf", global_plan_grf_viz_topic);
    quad_utils::loadROSParam(node_, "visualization/local_plan_grf", local_plan_grf_viz_topic);
    quad_utils::loadROSParam(node_, "visualization/current_grf", current_grf_viz_topic);
    quad_utils::loadROSParam(node_, "visualization/global_plan_discrete", discrete_body_plan_viz_topic);
    quad_utils::loadROSParam(node_, "visualization/foot_plan_discrete", foot_plan_discrete_viz_topic);
    quad_utils::loadROSParam(node_, "visualization/joint_states/estimate", estimate_joint_states_viz_topic);
    quad_utils::loadROSParam(node_, "visualization/joint_states/ground_truth", ground_truth_joint_states_viz_topic);
    quad_utils::loadROSParam(node_, "visualization/joint_states/trajectory", trajectory_joint_states_viz_topic);
    quad_utils::loadROSParam(node_, "visualization/state/estimate_trace", state_estimate_trace_viz_topic);
    quad_utils::loadROSParam(node_, "visualization/state/ground_truth_trace", ground_truth_trace_viz_topic);
    quad_utils::loadROSParam(node_, "visualization/state/trajectory_trace", trajectory_state_trace_viz_topic);
    ...
    // // Setup plan subs
    // global_plan_sub_ = nh_.subscribe<quad_msgs::msg::RobotPlan>(
    //     global_plan_topic, 1,
    //     boost::bind(&RVizInterface::robotPlanCallback, this, _1, GLOBAL));
    // local_plan_sub_ = nh_.subscribe<quad_msgs:::msg::RobotPlan>(
    //     local_plan_topic, 1,
    ...
    //     nh_.advertise<visualization_msgs::msg::Marker>(global_plan_viz_topic, 1);
    // local_plan_viz_pub_ =
    //     nh_.advertise<visualization_msgs::Marker>(local_plan_viz_topic, 1);
    // global_plan_grf_viz_pub_ = nh_.advertise<visualization_msgs::msg::MarkerArray>(
    //     global_plan_grf_viz_topic, 1);
    // local_plan_grf_viz_pub_ = nh_.advertise<visualization_msgs::msg::MarkerArray>(
    ...
    // foot_plan_discrete_viz_pub_ = nh_.advertise<visualization_msgs::msg::Marker>(
    //     foot_plan_discrete_viz_topic, 1);
    // local_plan_ori_viz_pub_ =
    //     nh_.advertise<geometry_msgs::msg::PoseArray>(local_plan_ori_viz_topic, 1);
    ...
    // state_estimate_sub_ = nh_.subscribe<quad_msgs::msg::RobotState>(
    ...
    // quad_utils::loadROSParam(nh_, "visualization/foot_0_plan_continuous",
    //                         foot_0_plan_continuous_viz_topic);
    // quad_utils::loadROSParam(nh_, "visualization/foot_1_plan_continuous",
    //                         foot_1_plan_continuous_viz_topic);
    // quad_utils::loadROSParam(nh_, "visualization/foot_2_plan_continuous",
    //                         foot_2_plan_continuous_viz_topic);
    // quad_utils::loadROSParam(nh_, "visualization/foot_3_plan_continuous",
    //                         foot_3_plan_continuous_viz_topic);
...
void RVizInterface::robotPlanCallback(const quad_msgs::msg::RobotPlan::ConstPtr msg, const int pub_id) 
{
    // // Initialize Path message to visualize body plan
...
void RVizInterface::grfCallback(const quad_msgs::msg::GRFArray::ConstPtr msg) 
{
...
void RVizInterface::discreteBodyPlanCallback(const quad_msgs::msg::RobotPlan::ConstPtr msg) 
{
...
void RVizInterface::footPlanDiscreteCallback(const quad_msgs::msg::MultiFootPlanDiscrete::ConstPtr msg) 
{
...
void RVizInterface::footPlanContinuousCallback(const quad_msgs::msg::MultiFootPlanContinuous::ConstPtr msg) 
{
...
void RVizInterface::robotStateCallback(const quad_msgs::msg::RobotState::ConstPtr msg, const int pub_id) 
{
    ...
    //   quad_utils::pointMsgToEigen(trajectory_state_trace_msg_.points.back(), last_pos);
