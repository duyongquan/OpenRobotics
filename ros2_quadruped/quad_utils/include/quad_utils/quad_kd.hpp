#ifndef ROS2_QUADRUPED__QUAD_SIMULATOR_QUAD_UTILS_QUAD_KD_HPP_
#define ROS2_QUADRUPED__QUAD_SIMULATOR_QUAD_UTILS_QUAD_KD_HPP_
...
private:
    ...
    const Eigen::VectorXd tau_max_ =
        ...
        knee_tau_max_, abad_tau_max_, hip_tau_max_, knee_tau_max_).finished();
    ...
    const Eigen::VectorXd vel_max_ =
        ...
        knee_vel_max_, abad_vel_max_, hip_vel_max_, knee_vel_max_).finished();
...
#endif  // ROS2_QUADRUPED__QUAD_SIMULATOR_QUAD_UTILS_QUAD_KD_HPP_