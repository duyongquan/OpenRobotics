#ifndef ROS2_QUADRUPED__QUAD_SIMULATOR_QUAD_UTILS_MATRIX_UTILS_HPP_
#define ROS2_QUADRUPED__QUAD_SIMULATOR_QUAD_UTILS_MATRIX_UTILS_HPP_
 ...
 * @return Created a block diagonal matrix
 */
Eigen::MatrixXd block_diag(const Eigen::MatrixXd &m1, const Eigen::MatrixXd &m2, const Eigen::MatrixXd &m3) 
{
    uint32_t m1r = m1.rows();
    uint32_t m1c = m1.cols();
    uint32_t m2r = m2.rows();
...
#endif  // ROS2_QUADRUPED__QUAD_SIMULATOR_QUAD_UTILS_MATRIX_UTILS_HPP_