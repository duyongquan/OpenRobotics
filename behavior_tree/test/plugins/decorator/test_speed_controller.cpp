...
#include "behavior_tree/plugins/decorator/speed_controller.hpp"

using namespace std::chrono;  // NOLINT
using namespace std::chrono_literals;  // NOLINT

class SpeedControllerTestFixture : public behavior_tree::BehaviorTreeTestFixture
{
public:
  void SetUp()
  {
    ...
    bt_node_ = std::make_shared<ros2_tutorials::behavior_tree::SpeedController>("speed_controller", *config_);
...
protected:
  static std::shared_ptr<ros2_tutorials::behavior_tree::SpeedController> bt_node_;
  static std::shared_ptr<behavior_tree::DummyNode> dummy_node_;
};

std::shared_ptr<ros2_tutorials::behavior_tree::SpeedController>
